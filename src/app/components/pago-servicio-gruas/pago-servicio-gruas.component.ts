...
@Component({
  selector: 'app-pago-servicio-gruas',
  templateUrl: './pago-servicio-gruas.component.html',
  styleUrls: ['./pago-servicio-gruas.component.css']
})
export class PagoServicioGruasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.pagoServiciosService.getPaysGruas()
    .subscribe(
      res => {
  ...
  getPayDetail(a:any, nombre:any, fecha_recepcion:any, precio:any, cantidad:any, tipo_fruta:any, precio_total:any, total_pago:any, adeudado:any){
  ...
  console.log('ingreso al metodo');
    this.pagoServiciosService.getPayDetailGruas(a)
    .subscribe(
      res => {
        this.payDetail = res;
        console.log(res);
  ...
  insertPay(dato:string, dato2: HTMLInputElement, dato3: HTMLInputElement){
    ...
    this.pagoServiciosService.insertPaysGruas(this.pagos_servicios)
    .subscribe(
      res => {
      console.log(res);        
      },
  ...
  BorrarPago(id_pago: string){
    Swal.fire({
      ...
      this.pagoServiciosService.deletePagoServicioGruas(id_pago)
      .subscribe(
        res => {
          console.log(res);          
          this.ngOnInit();
  ...
  reportePDF(){
    ...
    doc.text('Detalles del Reporte - Servicio de Grúas', 75,55);
    ...
    generatePDF(){
      ...
      doc.text('Tipo Fruta: ', 50,55);
      doc.text(tipofrutahtml,100,55);
      ...
      doc.text('Total Pago: ', 50,75);
      doc.text(totalPagohtml,100,75);
      doc.text('Adeudado: ', 50,80);
      doc.text(adeudadohtml,100,80);
